...
public class CoinGestureListener : MonoBehaviour, KinectGestures.GestureListenerInterface
{
    ...
    private static CoinGestureListener instance = null;
    ...
    public static CoinGestureListener Instance
    {
        get
        {
            return instance;
